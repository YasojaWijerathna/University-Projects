...
import lk.styrox.pharma_care.dialogs.Brand_Registration;
import lk.styrox.pharma_care.dialogs.Brand_Update;
...
public class Brand_Management extends javax.swing.JPanel {
    ...
    JFrame parentFrame;
    public Brand_Management(JFrame parent) {
        initComponents();
    ...
    private void initComponents() {
        ...
        roundButton1.setText("Add Brand");
        ...
        roundButton5.setText("Update Brand");
        ...
        background2Layout.setHorizontalGroup(
            ...
            .addGroup(background2Layout.createSequentialGroup()
                ...
                .addComponent(roundButton5, javax.swing.GroupLayout.PREFERRED_SIZE, 153, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(22, 22, 22))
        );
    ...
    private void roundButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_roundButton1ActionPerformed
        new Brand_Registration(parentFrame, true).setVisible(true);
        loadTable();
    ...
    private void roundButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_roundButton5ActionPerformed
       ...
       if(selectedRow >=0){
           ...
           new Brand_Update(parentFrame, true, brandID).setVisible(true);
           loadTable();
       }else{
           Notifications.getInstance().show(Notifications.Type.WARNING,
