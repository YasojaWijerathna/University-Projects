...
import lk.styrox.pharma_care.dialogs.Supplier_Registration;
import lk.styrox.pharma_care.dialogs.Supplier_Update;
 ...
 * @author dnana
 */
public class Supplier_Management extends javax.swing.JPanel {
     ...
     */
    public Supplier_Management(JFrame parent) {
        initComponents();
        parentFrame = parent;
        loadTable();
    }
    ...
    private void initComponents() {
        ...
        roundButton1.setText("Register Supplier");
        ...
        roundButton5.setText("Update Supplier Detail");
        ...
        background2Layout.setHorizontalGroup(
            ...
            .addGroup(background2Layout.createSequentialGroup()
                ...
                .addComponent(roundButton5, javax.swing.GroupLayout.PREFERRED_SIZE, 229, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(21, 21, 21))
        );
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Full Name", "Mobile", "Status", "Company"
            }
        ) {
            ...
            .addGroup(background1Layout.createSequentialGroup()
                ...
                .addGroup(background1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(background1Layout.createSequentialGroup()
                        ...
                        .addGap(20, 20, 20)
                        .addComponent(tableScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 727, Short.MAX_VALUE))
    ...
    private void roundButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_roundButton1ActionPerformed
        new Supplier_Registration(parentFrame, true).setVisible(true);
        loadTable();
    ...
    private void roundButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_roundButton5ActionPerformed
        ...
        if (selectedRow >= 0) {
            String supplierID = String.valueOf(jTable1.getValueAt(selectedRow, 0));

            new Supplier_Update(parentFrame, true, supplierID).setVisible(true);
            loadTable();

        } else {
            Notifications.getInstance().show(Notifications.Type.WARNING,
                    Notifications.Location.TOP_CENTER, "Please Select a Supplier from the table");
        }
    ...
    private void roundButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_roundButton2ActionPerformed
        ...
        if (supplier_id.isBlank() && name.isBlank()) {
            Notifications.getInstance().show(Notifications.Type.WARNING,
                    Notifications.Location.TOP_CENTER, "Please enter Search details");
            loadTable();
        } else if (!supplier_id.isBlank() && name.isBlank()) {
            query = query + " AND `supplier`.`id` LIKE '%" + supplier_id + "%'";
        } else if (supplier_id.isBlank() && !name.isBlank()) {
            query = query + " AND (`user`.`fname` LIKE '%" + name + "%' "
                    + "OR `user`.`lname` LIKE '%" + name + "%' )";
        } else {
            loadTable();
        }
