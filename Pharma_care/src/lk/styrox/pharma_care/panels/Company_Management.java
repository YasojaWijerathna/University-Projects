...
import lk.styrox.pharma_care.dialogs.Company_Registration;
import lk.styrox.pharma_care.dialogs.Company_Update;
...
public class Company_Management extends javax.swing.JPanel {
     ...
     */
    public Company_Management(JFrame parent) {
        initComponents();
        parentFrame = parent;
    ...
    private void initComponents() {
        ...
        roundButton1.setText("Add Company");
        ...
        roundButton5.setText("Update Company Details");
        ...
        background2Layout.setHorizontalGroup(
            ...
            .addGroup(background2Layout.createSequentialGroup()
                ...
                .addComponent(roundButton1, javax.swing.GroupLayout.PREFERRED_SIZE, 156, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(roundButton5, javax.swing.GroupLayout.PREFERRED_SIZE, 238, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(22, 22, 22))
        );
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Company Name", "Company Mobile"
            }
        ) {
    ...
    private void roundButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_roundButton1ActionPerformed
        new Company_Registration(parentFrame, true).setVisible(true);
        loadTable();
    ...
    private void roundButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_roundButton5ActionPerformed
        ...
        if (selectedRow >= 0) {
            String CompanyID = String.valueOf(jTable1.getValueAt(selectedRow, 0));

            new Company_Update(parentFrame, true, CompanyID).setVisible(true);
            loadTable();

        } else {
            Notifications.getInstance().show(Notifications.Type.WARNING,
                    Notifications.Location.TOP_CENTER, "Please Select a brand from the table");
        }
