 ...
 * @author dnana
 */
public class Category_Update extends javax.swing.JDialog {

    String categoryID="";
  
    public Category_Update(java.awt.Frame parent, boolean modal,String cateID) {
        super(parent, modal);
        initComponents();
        categoryID=cateID;
        loadCategory();
     ...
     private void loadCategory(){
        try {
            ResultSet brand = Mysql.search("SELECT * FROM `category`"
                    + "WHERE `id`='" + categoryID + "'");
            if (brand.next()) {
            
                roundTextField3.setText(categoryID);
    ...
    private void roundButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_roundButton2ActionPerformed
        ...
        if ( name.isBlank()) {
            Notifications.getInstance().show(Notifications.Type.WARNING,
                Notifications.Location.TOP_CENTER, "Please enter category name");
        } else {
            Mysql.iud("UPDATE `category` SET `name`='"+name+"' WHERE `id`='" + categoryID + "'  ");
            Notifications.getInstance().show(Notifications.Type.SUCCESS,
                Notifications.Location.TOP_CENTER, "Category Details Successfully Updated");
