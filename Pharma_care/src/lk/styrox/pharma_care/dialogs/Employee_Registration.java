...
public class Employee_Registration extends javax.swing.JDialog {
    ...
    /**
     * Creates new form Employee_Dialog
     */
    ...
    private String getUserID() {
        String newID = "";
        try {
            ResultSet rs = Mysql.search("SELECT * FROM `user` WHERE `id` LIKE 'U_%' ORDER BY `id` DESC LIMIT 1 ");
    ...
    private void initComponents() {
        ...
        background1Layout.setHorizontalGroup(
                        ...
                        .addGroup(background1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, background1Layout.createSequentialGroup()
                                ...
                                .addGroup(background1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(roundPasswordField1, javax.swing.GroupLayout.DEFAULT_SIZE, 289, Short.MAX_VALUE)
            ...
            .addGroup(background1Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(roundedBtn1, javax.swing.GroupLayout.PREFERRED_SIZE, 400, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        if (fname.isBlank()) {
            ...
            Notifications.getInstance().show(Notifications.Type.WARNING,
                ...
                Mysql.iud("INSERT INTO `user` (`id`,`fname`,`lname`,`email`,`join_date`,`user_type_id`,`status_id`)"
                        ...
                        + "'" + sdf.format(new Date()) + "','2','" + statusMap.get(status) + "')");
                ...
                if (!mobile2.isBlank() && mobile2.matches(Validation.MOBILE_VALIDATION.validate())) {
                    Mysql.iud("INSERT INTO `mobile` (`mobile`,`user_id`) VALUES ('" + mobile2 + "','U_" + userID + "') ");
                }

                Mysql.iud("INSERT INTO `login`(`username`, `password`, `user_id`) VALUES('" + username + "', '" + password + "', 'U_" + userID + "')");

                Notifications.getInstance().show(Notifications.Type.SUCCESS,
                        Notifications.Location.TOP_CENTER, "Employee Registered Successfully");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Employee_Registration dialog = new Employee_Registration(new javax.swing.JFrame(), true);
