...
public class Category_Registration extends javax.swing.JDialog {
    ...
    /**
     * Creates new form Category_Registration
     */
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Register Category");
    ...
    private void roundButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_roundButton2ActionPerformed
        ...
        if ( name.isBlank()) {
            ...
            Mysql.iud("INSERT INTO `category` (`name`) VALUE ('"+name+"')");

            Notifications.getInstance().show(Notifications.Type.SUCCESS,
                Notifications.Location.TOP_CENTER, "Category Successfully Registered");
