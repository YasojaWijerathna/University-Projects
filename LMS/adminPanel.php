                    ...
                    <div class="row ">
                        <div class="col-12 align-items-start   ">
                            <div class="row g-1 text-center justify-content-center ">
                                ...
                                <div class="col-6">
                                    <button class="btn rounded-5 text-white" style="background-color: #8956ea;" onclick="editProfile2();">Edit Profile</button>
                                </div>
                                ...
                                <div class="row g-1 text-center  ">
                                    ...
                                    <div class="nav flex-column nav-pills me-3 mt-3" role="tablist" aria-orientation="vertical">
                                        <nav class="nav flex-column">
                                            <a class="nav-link active border border-dark" aria-current="page" href="adminPanel.php">Teacher & Academic <br>Registrations</a>
                ...
                <div class="col-12 col-lg-10 ">
                    ...
                    <div class="row  ">
                        ...
                        <div class="text-dark fw-bold mb-1 mt-3">
                            <h2 class="fw-bold text-warning">Register Teacher/ Academic Officer</h2>
                        </div>
                        <div class="col-12">
                            <hr />
                        </div>
                        <div class=" col-11 ms-5 mx-2 " id="profileEdit">
                            <div class=" p-3 ">
                                ...
                                <div class="row ">
                                    <div class="col-6 ">
                                        <select name="" id="occupation" onchange="changeUI();" class="form-select mt-1">
                                            <option value="0">Please Select an Occupation</option>
                                            <option value="1">Teacher</option>
                                            <option value="2">Academic Officer</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-5">
                                    ...
                                    <div class="row d-none" id="teacherRow">
                                ...
                                <div class="row  mt-4 justify-content-center">
                                    <div class=" col-3 ms-6     ">
                                        <button type="button" class="btn " style="background-color:#007bff ; color: white;" onclick="registration();">Register % Invite </button>
                                    </div>
                                </div>
