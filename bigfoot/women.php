...
<head>
    <title>BigFoot | Women's Footwear</title>
    <meta charset="utf-8">
    ...
    <div class="page">
        ...
        <div class="breadcrumbs">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <p class="bread"><span><a href="home.php">Home</a></span> / <span>Women</span></p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-12 mb-2">
                            <div class="sidebar border mb-1">
                                ...
                                <ul>
                                    ...
                                    ?>
                                        <li><a class="text-info" onclick="loadProductByBrand(<?php echo $brand_data['id']; ?>,2)" href="#"><?php echo $brand_data["name"]; ?></a></li>
                                    <?php
                                    }
                                    ?>
                                </ul>
                ...
                <div class="col-lg-9 col-sm-12" id="productContent">
                    <div class="row d-flex justify-content-sm-center justify-content-lg-start" style="padding-bottom: 4em">
                        ...
                        $selected_rs = Database::search("SELECT * FROM `product` INNER JOIN `stock` ON `stock`.`product_id`=`product`.`id`
                          WHERE `gender_id`='2' AND `stock`.`status_id`='1' ");
                        ...
                        ON `stock`.`product_id`=`product`.`id` WHERE `gender_id`='2' AND `stock`.`status_id`='1' 
