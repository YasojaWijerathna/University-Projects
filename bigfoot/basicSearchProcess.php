...
<?php
    ...
    $query = "SELECT * FROM `product` WHERE `status_id`='1' AND `title` LIKE '%" . $txt . "%' ";
?>


    <div style="padding: 7em 0; clear: both;">
        <div class="container">
                        ...
                        <div class="col-lg-3 mb-4 text-center">
                            <div class="product-card border">
                                <a href="<?php echo "singleProduct.php?id=" . ($product_data["id"]) ?>" class="prod-img">
                                    ...
                                    ?>
                                    <img src="<?php echo $image_data["code"]; ?>" class="img-fluid" style="height:280px ;">
                                </a>
